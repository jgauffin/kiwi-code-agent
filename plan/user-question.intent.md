## A1 (new) docs/intent/agent.md#The mapping run has no voice
- from: F4 (naive)
...
## A2 (new) docs/intent/agent.md#Waiting for the person
- from: F5 (naive)
...
## A3 (new) docs/intent/agent.md#What a session is offered
- from: F8 (naive)
...
## A4 (new) docs/intent/agent.md#Interrupting [applied]
- from: F7 (naive)
